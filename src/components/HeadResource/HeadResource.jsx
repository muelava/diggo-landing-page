...
const HeadResource = () => {
  return (
    <>
      <section className="px-5 md:px-10 pb-20 pt-40 flex flex-col md:flex-row items-center gap-5 lg:gap-10 head-resource" style={{ backgroundImage: `url(${backgroundBeforeFooter})` }}>
