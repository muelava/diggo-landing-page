  ...
  return (
    <HelmetProvider>
      <>
        ...
        <main>
          {/* jumbotron */}
          <section className="relative overflow-hidden" style={{ backgroundImage: `url(${backgroundJumbotron})`, backgroundRepeat: "no-repeat", backgroundSize: "cover" }}>
            <div className="jumbotron h-full flex items-center">
              <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-around gap-5 md:gap-20 lg:gap-10 px-3 pt-32 lg:py-48 max-w-screen-xl mx-auto">
                <div className="text-white w-full lg:w-1/2">
                  <h2 className="font-bold text-2xl md:text-6xl mb-3" style={{ lineHeight: "1.25" }}>
          ...
          {/* all featured */}
          <section className="px-5 pt-20 featured max-w-screen-xl mx-auto">
          ...
          {/* value */}
          <section className="px-5 mt-20 pt-20 pb-10 values max-w-screen-xl mx-auto">
